...
It is highly recommended that when you start a new game you immediately go to Options and Rename Save. You have to create a Restore Point for it to stick. It is also highly recommended that you give it a **unique** name from all the other Game Saves you have. I suggest not putting the S\<slot number> in their like I did before I wrote this app. If you don't give it a Save Name it will be "Unnamed Save" in manager and you won't be able to change it later without creating another backup. My philosophy now is to save slots 14 and 15 as your scratch pad for moving backups too. Later I want to add a search by Save Name that lists all the slots you have backups in. Unfortunately you can't rename a backup without changing its 'mtime' and I don't want to touch the save files.
